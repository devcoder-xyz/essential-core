...
namespace Essential\Core\Middlewares;
...
use Essential\Core\Http\Exception\MethodNotAllowedException;
use Essential\Core\Http\Exception\NotFoundException;
use Essential\Core\Middlewares\Router\AuraRouterMiddleware;
use Essential\Core\Middlewares\Router\SymfonyRouterMiddleware;
use DevCoder\Router;
...
final class RouterMiddleware implements MiddlewareInterface
{
        ...
        RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        throw new LogicException(
            sprintf(
                'You cannot use "Essential Framework" as router is not installed. Try running %s.',
